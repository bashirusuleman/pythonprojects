...
# Requesting for animals to see
try:
    while True:
        print("Type a number 0-5 to choose animal or type 'exit' to quit, [0=camel, 1=lion, 2=deer, 3=goose, 4=bat, 5=rabbit ")
        next_habitat = input("Which habitat  do you need? > ")
        if next_habitat != "exit":
